...
export default function PostRidePage() {
  ...
  const setField = (k) => (e) => { setForm((f) => ({ ...f, [k]: e.target.value })); setErrors((er) => ({ ...er, [k]: "" })); };
      ...
      <div className="success-overlay">
        ...
        <div className="success-box">
          ...
          <p style={{ color: "#71717a", fontSize: "0.88rem", lineHeight: 1.6, margin: "0 0 1.5rem 0" }}>
            Your ride from <strong style={{ color: "#f4f4f5" }}>{createdRide.origin}</strong> to <strong style={{ color: "#f4f4f5" }}>{createdRide.destination}</strong> is now live.
          </p>
    ...
    <PageShell>
      ...
      <div style={{ maxWidth: 800, margin: "0 auto", padding: "2.5rem 1.5rem" }}>
        ...
        <div className="fade-up" style={{ display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "1.75rem" }}>
          {[[step1done, "Route", 1], [step2done, "Time", 2], [step3done, "Pricing", 3]].map(([done, label, num], i, arr) => (
            <div key={label} style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
              <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "0.25rem" }}>
                <div style={{
                  width: 32, height: 32, borderRadius: "50%", display: "flex", alignItems: "center", justifyContent: "center",
                  fontFamily: "Syne, sans-serif", fontWeight: 700, fontSize: "0.8rem", flexShrink: 0, transition: "all 0.3s",
              ...
              {i < arr.length - 1 && (
                <div style={{ flex: 1, height: 1, background: done ? "rgba(34,197,94,0.3)" : "rgba(255,255,255,0.07)", width: 40, marginBottom: "1rem", transition: "background 0.3s" }} />
              )}
            </div>
          ))}
        </div>
